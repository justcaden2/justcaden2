...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        const embed = new MessageEmbed()
            ...
            embed.setDescription(`**[Invite Bot](https://discord.com/api/oauth2/authorize?client_id=799784473524305982&permissions=8&scope=bot)** **[Support Server](https://discord.gg/TETb8u9aft)** **These Are the Available Commands For ${message.guild.me.displayName}\nBot's Global Prefix Is \`${PREFIX}\`\nServer Prefix Is \`${prefix}\`\n\nFor Help Related To A Particular Command Type -\n\`${prefix}help [command name | alias]\`**`)
